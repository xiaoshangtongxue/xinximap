...
/******/ 	return __webpack_require__(__webpack_require__.s = "./demo-projection-01.js");
/******/ })
/************************************************************************/
/******/ ({
...
class Map extends _util_subject__WEBPACK_IMPORTED_MODULE_8__["Subject"] {
    ...
    showTooltip(feature, field) {
        ...
        const text = '<br>' + "<br>" + "<br>" + '<br>' + "<br>" + '<br>' + "<h style=\"font-weight:bold\">公司名称:</h>" + feature.properties[field.name] + '<br>' + "<h style=\"font-weight:bold\">公司法人:</h>" + feature.properties[field.company_auth] + '<br>' + "<h style=\"font-weight:bold;\">公司类型:</h>" + feature.properties[field.company_categary] + '<br>' + "<h style=\"font-weight:bold;\">公司二级行业:</h>" + feature.properties[field.sector] + '<br>' + "<h style=\"font-weight:bold;\">获批准年:</h>" + feature.properties[field.company_year] + '<br>' + "<h style=\"font-weight:bold;\">注册时间:</h>" + feature.properties[field.company_time] + '<br>' + "<h style=\"font-weight:bold;\">公司介绍:</h>" + feature.properties[field.company_introduction] + '<br>' + "<h style=\"font-weight:bold;\">公司地址:</h>" + feature.properties[field.company_address] + '<br>' + "<h style=\"font-weight:bold;\">备注:</h>" + feature.properties[field.company_remark];
        // const text = "点击显示详情";
    ...
    showTooltip1(feature, field) {
        ...
        const text = '<br>' + "<br>" + "<br>" + '<br>' + "<br>" + '<br>' + "<h style=\"font-weight:bold;\">成果名称:</h>" + feature.properties[field.name] + '<br>' + "<h style=\"font-weight:bold;\">成果完成人:</h>" + feature.properties[field.ach_people] + '<br>' + "<h style=\"font-weight:bold;\">成果完成单位:</h>" + feature.properties[field.ach_unit] + '<br>' + "<h style=\"font- weight:bold;\">关键词:</h>" + feature.properties[field.ach_keywords] + '<br>' + "<h style=\"font-weight:bold;\">中图分类号:</h>" + feature.properties[field.ach_clc] + '<br>' + "<h style=\"font-weight:bold;\">成果简介:</h>" + feature.properties[field.ach_introduction] + '<br>' + "<h style= \"font-weight:bold;\">成果类别:</h>" + feature.properties[field.ach_categary] + '<br>' + "<h style=\"font-weight:bold;\">成果入库时间:</h>" + feature.properties[field.ach_inyear] + '<br>' + "<h style=\"font-weight:bold;\">成功水平:</h>" + feature.properties[field.ach_level] + '<br>' + "<h style=\"font-weight:bold;\">成果一级行业:</h>" + feature.properties[field.ach_prisectorsector] + '<br>' + "<h style=\"font-weight:bold;\">成果二级行业:</h>" + feature.properties[field.ach_auxsectorsector];
        const center = feature.geometry.getCenter(_geometry_geometry__WEBPACK_IMPORTED_MODULE_0__["CoordinateType"].Projection, this.projection);
        const matrix = this._ctx.getTransform();
        const screenX = (matrix.a * center[0] + matrix.e);
        const screenY = (matrix.d * center[1] + matrix.f);
    ...
    showTooltip2(feature, field) {
        //const text=feature.properties[field.auth];
        // const text ="公司名字:"+ feature.properties[field.name]+'<br>'+"法人:"+feature.properties[field.auth]+'<br>'+"公司属性:"+ feature.properties[field.categary]+'<br>'+"主营领域:"+feature.properties[field.sector]+'<br>'+"成立时间:"+ feature.properties[field.year]+'<br>'+"公司介绍:"+feature.properties[field.introduction]+'<br>'+"公司地址:"+feature.properties[field.address];
        const text = '<br>' + "<br>" + "<br>" + '<br>' + "<br>" + '<br>' + "<h style=\"font-weight:bold;\">仪器名称:</h>" + feature.properties[field.name] + '<br>' + "<h style=\"font-weight:bold;\">仪器地址:</h>" + feature.properties[field.instrument_address] + '<br>' + "<h style=\"font-weight:bold;\">仪器分类:</h>" + feature.properties[field.instrument_category] + '<br>' + "<h style=\"font-weight:bold;\">仪器使用付费:</h>" + feature.properties[field.instrument_pay] + '<br>' + "<h style=\"font-weight:bold;\">仪器一级行业:</h>" + feature.properties[field.instrument_prisectorsector] + '<br>' + "<h style=\"font-weight:bold;\">仪器二级行业:</h>" + feature.properties[field.instrument_auxsectorsector] + '<br>' + "<h style=\"font-weight:bold;\">联系人:</h>" + feature.properties[field.instrument_contact] + '<br>' + "<h style=\"font-weight:bold;\">联系电话:</h>" + feature.properties[field.instrument_phone] + '<br>' + "<h style=\"font-weight:bold;\">是否可复用:</h>" + feature.properties[field.instrument_reuse] + '<br>' + "<h style=\"font-weight:bold;\">备注:</h>" + feature.properties[field.instrument_remark];
        const center = feature.geometry.getCenter(_geometry_geometry__WEBPACK_IMPORTED_MODULE_0__["CoordinateType"].Projection, this.projection);
        const matrix = this._ctx.getTransform();
        const screenX = (matrix.a * center[0] + matrix.e);
        const screenY = (matrix.d * center[1] + matrix.f);
    ...
    showTooltip4(feature, field) {
        //const text=feature.properties[field.auth];
        // const text ="公司名字:"+ feature.properties[field.name]+'<br>'+"法人:"+feature.properties[field.auth]+'<br>'+"公司属性:"+ feature.properties[field.categary]+'<br>'+"主营领域:"+feature.properties[field.sector]+'<br>'+"成立时间:"+ feature.properties[field.year]+'<br>'+"公司介绍:"+feature.properties[field.introduction]+'<br>'+"公司地址:"+feature.properties[field.address];
        const text = '<br>' + "<br>" + "<br>" + '<br>' + "<br>" + '<br>' + "<h style=\"font-weight:bold;\">教师姓名:</h>" + feature.properties[field.name] + '<br>' + "<h style=\"font-weight:bold;\">教师职称:</h>" + feature.properties[field.teacher_position] + '<br>' + "<h style=\"font-weight:bold;\">研究方向:</h>" + feature.properties[field.teacher_research] + '<br>' + "<h style=\"font-weight:bold;\">所在学院:</h>" + feature.properties[field.teacher_college] + '<br>' + "<h style=\"font-weight:bold;\">科研项目:</h>" + feature.properties[field.teacher_program] + '<br>' + "<h style=\"font-weight:bold;\">所属一级行业:</h>" + feature.properties[field.teacher_prisectorsector] + '<br>' + "<h style= \"font-weight:bold;\">所属二级行业:</h>" + feature.properties[field.teacher_auxsectorsector] + '<br>' + "<h style=\"font-weight:bold;\">十四大行业:</h>" + feature.properties[field.teacher_fourthsector] + '<br>' + "<h style=\"font-weight:bold;\">备注:</h>" + feature.properties[field.teacher_remark];
        const center = feature.geometry.getCenter(_geometry_geometry__WEBPACK_IMPORTED_MODULE_0__["CoordinateType"].Projection, this.projection);
        const matrix = this._ctx.getTransform();
        const screenX = (matrix.a * center[0] + matrix.e);
        const screenY = (matrix.d * center[1] + matrix.f);
  ...
  search7.onclick=function(){
   if (box4.checked==true){
     ...
     req.onload = (event) => {
       ...
       let highlight = new _dist__WEBPACK_IMPORTED_MODULE_0__["SimplePointSymbol"]();
       ...
       search4.onclick=function(){
         if (box1.checked==true){
           ...
           JSON.parse(req.responseText).features.map(item=> {
             const polyline = new _dist__WEBPACK_IMPORTED_MODULE_0__["Polyline"]([item.point,[112.593756,37.805857]]);
...
/******/ });
//# sourceMappingURL=bundle-04-01.js.map