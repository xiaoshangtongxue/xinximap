...
/******/ 	return __webpack_require__(__webpack_require__.s = "./demo-company.js");
/******/ })
/************************************************************************/
/******/ ({
...
window.load = () => { 
    ...
    const amap = new AMap.Map("amap", {
       ...
       // 设置光照
    amap.AmbientLight = new AMap.Lights.AmbientLight([1, 1, 1], 0.5);
    amap.DirectionLight = new AMap.Lights.DirectionLight([0, 0, 1], [1, 1, 1], 1);
  ...
  }).search('小店区', function (status, result) {
 ...
 //更改地图风格
  ...
      dog.send(null);
   ...
   //页面开始显示数据信息
    const req = new XMLHttpRequest();
    const url="http://119.29.130.157:8000/company/";
    req.onload = (event) => {
 ...
 //返回数据
   ...
   // req1.open("GET","assets/geojson/a.json",true);
    req.open("GET",url,true);
    req.send(null);
...
                  for (number_j;number_j <list1.length;number_j++) {
                  (function(number_j)  {
                       
                      var company_number_id=document.getElementById("id"+number_j);
                      company_number_id.addEventListener("click", function(e) {
...
                    // var o=JSON.parse(req.responseText).features[j].point[1];
                            ...
                            box.checked=false; 
                            box2.checked=false;
                            const n="http://119.29.130.157:8000/ComMultisearch/?company_prisector="+document.getElementById("id"+number_j).innerText;
                          // const n="http://119.29.130.157:8000/company";
                            ...
                            req.onload = (event) => {
                              ...
                              featureLayer.on("click", (event) => {
                                ...
                                map.setView([event.feature.properties.point[0],event.feature.properties.point[1]],8);
                                map.showTooltip(event.feature,field); 
                                company_botton.onclick=function(){
                                  //alert(event.feature.properties.company_name);
                                  $('#table-body').empty()
...
//产业
 ...
                     // var o=JSON.parse(req.responseText).features[j].point[1];
                            ...
                            $('#pagination-wrapper_search').empty();
                             ...
                             box.checked=false; 
                             box2.checked=false;
                             const n="http://119.29.130.157:8000/ComMultisearch/?company_fourthsector="+document.getElementById("chanye_"+chanye_j).innerText;
                           // const n="http://119.29.130.157:8000/company";
                             const req = new XMLHttpRequest();
                             const url3=n;
                             req.onload = (event) => {
...
road_sure_click.onclick=function(){
   ...
   if(document.getElementById("select").value!="" )
    {
      ...
      const req = new XMLHttpRequest();
      const url5='http://119.29.130.157:8000/ComMultisearch/?company_'+document.getElementById("select").value;
 ...
                             success: function(result) {
                                 ...
                                 var  container_data_number = document.getElementById('container_company3') ;
 ...
                     })()
   ...
    var myinput=document.getElementById("myinput");
    search.onclick=function(){
      ...
      if(document.getElementById("select_lower").value=="relative"){
   
     
        toMessage(myinput.value);
        
    
      }else if(document.getElementById("select_lower").value=="company-teacher"){
   
     
        toMessage_company_teacher(myinput.value);
        
    
      }else if(document.getElementById("select_lower").value=="predict"){
        $('#btn2').click();
        companyPrise();
      }
      driving.clear();
      ...
      const req = new XMLHttpRequest();
      const url5='http://119.29.130.157:8000/ComMultisearch/?company_'+document.getElementById("select_lower").value;
...
for(var i=0;i<navList.length;i++){
  ...
   }
navList[0].click();
  function toMessage(sendMessage) {
          // var getval = "valueTest中文字符";
          // var getval2 = "valueTest2";
          console.log(sendMessage)
          //window.location.href = "http://127.0.0.1:8000/relative-map/?name=" + sendMessage;http://119.29.130.157:8000/entrance/
          window.location.href = "http://119.29.130.157:8000/relative-company/?name=" + sendMessage;
   
      }
    function toMessage_company_teacher(sendMessage) {
            // var getval = "valueTest中文字符";
            // var getval2 = "valueTest2";
            console.log(sendMessage)
            //window.location.href = "http://127.0.0.1:8000/relative-map/?name=" + sendMessage;http://119.29.130.157:8000/entrance/
            window.location.href = "http://119.29.130.157:8000/relative-company-teacher/?name=" + sendMessage;
     
        }
  //返回Json文件的长度的函数
...
                            success: function(result) {
                                 ...
                                 var  container_data_number = document.getElementById('container_company2') ;
                                 var  cc = document.createTextNode('总计' + result_length + '个标注');
                                 container_data_number.appendChild(cc);
                                  var state = {
                                     'querySet': list_data,
...
                            type: "get",
                            async: false, //同步执行
                            url: "http://119.29.130.157:8000/company/",
                            dataType: "text", //返回数据形式为json
                            success: function(result) {
                            console.log(JSON.parse(result).features)
                            var list_data=JSON.parse(result).features 
                            ...
                            var result_length = JSON.parse(result).count
                            var  container_data_number = document.getElementById('container_company1') ;
                            var  cc = document.createTextNode('总计' + result_length + '个标注');
                            container_data_number.appendChild(cc);               
                           ...
                           function pageButtons(pages) {
                               ...
                               $('.page').on('click', function() {
                                  ...
                                  box.checked=false; 
                                  box2.checked=false;
                                  var n="http://119.29.130.157:8000/company/?page="+this.value;
                                  const req1 = new XMLHttpRequest();
                                  const url3=n;
                                  req1.onload = (event) => {
                                    const featureClass = new _dist__WEBPACK_IMPORTED_MODULE_0__["FeatureClass"]();
                                       ...
                                       a.onclick=function(){
                                            ...
                                                                //  map.setView([k,o],20);
                                                                  ...
                                                                  req1.onload = (event) => {
                                                                    ...
                                                                    featureLayer.label = label; // 把label给featurelayer
                                                                    featureLayer.labeled = true;
                                                                    //alert(JSON.parse(req1.responseText).features[0].point[0])
                                                                    //console.log(JSON.parse(req1.responseText).features);
                                                                    map.setView([JSON.parse(req1.responseText).features[0].point[0],JSON.parse(req1.responseText).features[0].point[1]],13);
                                                                    search3.onclick=function(){
                                                                      if (box.checked==true){
...
 var relativeSearch = (function() {
  ...
  function autoInput(){
    ...
                       async: false, //同步执行
                                //url: "http://119.29.130.157:8000/boot/"+realtivedata,
                       url:'http://119.29.130.157:8000/ComMultisearch/?company_name='+keywords,
                       dataType: "text", //返回数据形式为json
                       success: function(result) {
                     ...
                     const urlTrue1 ='http://119.29.130.157:8000/ComMultisearch/?company_name='+keywords;
...
function companyPrise(){
  $('.btnClose').click(function() {
    click_set_predict.checked=false;
   });

var dom = document.getElementById("container_predict");
...
xAxis: {
type: 'category',
data: [1981,1982,1983,1984,1985,1986,1987,1988,1989,1990,1991,1992,1993,1994,1995,1996
...
/******/ });
//# sourceMappingURL=bundle-02.js.map