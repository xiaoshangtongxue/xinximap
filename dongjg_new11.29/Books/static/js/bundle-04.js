...
/******/ 	return __webpack_require__(__webpack_require__.s = "./demo-projection.js");
/******/ })
/************************************************************************/
/******/ ({
...
class FeatureClass {
    ...
    loadGeoJSON(data) {
        Array.isArray(data.features) && data.features.forEach(item => {
            ...
            const point = new _geometry_point__WEBPACK_IMPORTED_MODULE_2__["Point"](item.point[0], item.point[1]);
            this._features.push(new _element_feature__WEBPACK_IMPORTED_MODULE_0__["Feature"](point, item));
    ...
    loadGeoJSON1(data) {
        Array.isArray(data.features) && data.features.forEach(item => {
            //TODO: each feature has one type that is ridiculous, cause geojson is a featurecollection, not a featurelayer.
            this._type = _geometry_geometry__WEBPACK_IMPORTED_MODULE_1__["GeometryType"].Point;
            const point = new _geometry_point__WEBPACK_IMPORTED_MODULE_2__["Point"](item.point1[0], item.point1[1]);
            this._features.push(new _element_feature__WEBPACK_IMPORTED_MODULE_0__["Feature"](point, item));
            /* const symbol = new LetterSymbol();  //渲染点
             symbol.strokeStyle = "#ffffff";
             symbol.fillStyle = "#ff0000";
...
class Feature extends _util_subject__WEBPACK_IMPORTED_MODULE_2__["Subject"] {
     ...
     */
    constructor(geometry, item, symbol) {
...
/*!************************!*\
  !*** ../dist/index.js ***!
  \************************/
/*! exports provided: Map, Viewer, Entity, FeatureClass, FieldType, Field, EditorActionType, Editor, Graphic, Feature, CoordinateType, GeometryType, Geometry, Point, Polyline, Polygon, MultiplePoint, MultiplePolyline, MultiplePolygon, Layer, GraphicLayer, FeatureLayer, Collision, NullCollision, SimpleCollision, CoverCollision, Label, Tooltip, Tooltip1, Symbol, PointSymbol, LineSymbol, FillSymbol, SimpleTextSymbol, SimplePointSymbol, GradientPointSymbol, SimpleLineSymbol, SimpleFillSymbol, SimpleMarkerSymbol, LetterSymbol, ArrowSymbol, ClusterSymbol, VertexSymbol, Renderer, SimpleRenderer, CategoryRendererItem, CategoryRenderer, ClassRendererItem, ClassRenderer, LatLngType, Projection, WebMercator, BD09, GCJ02, NoopProjection, Utility, Bound, Color, Subject, Animation, PointAnimation, LineAnimation, ParticleAnimation, Raster, RasterLayer, Kriging, Heat, InverseDistanceWeight, Tile, MeasureActionType, Measurer, Grid, DotRenderer1, DotRenderer2, DotRenderer3, DotRenderer4, DotRenderer5 */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Tooltip1", function() { return _tooltip_tooltip__WEBPACK_IMPORTED_MODULE_20__["Tooltip1"]; });
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "DotRenderer1", function() { return _renderer_dot_renderer__WEBPACK_IMPORTED_MODULE_45__["DotRenderer1"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "DotRenderer2", function() { return _renderer_dot_renderer__WEBPACK_IMPORTED_MODULE_45__["DotRenderer2"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "DotRenderer3", function() { return _renderer_dot_renderer__WEBPACK_IMPORTED_MODULE_45__["DotRenderer3"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "DotRenderer4", function() { return _renderer_dot_renderer__WEBPACK_IMPORTED_MODULE_45__["DotRenderer4"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "DotRenderer5", function() { return _renderer_dot_renderer__WEBPACK_IMPORTED_MODULE_45__["DotRenderer5"]; });
...
class Label {
    constructor() {
        ...
        this.collision1 = new _collision__WEBPACK_IMPORTED_MODULE_1__["CoverCollision"]();
    }
    /**
     * 绘制图层标注
     * @param {Feature[]} features - 准备绘制标注的要素集合
...
class Map extends _util_subject__WEBPACK_IMPORTED_MODULE_8__["Subject"] {
    ...
    constructor(id, option) {
        ...
        this._tooltip1 = new _tooltip_tooltip__WEBPACK_IMPORTED_MODULE_9__["Tooltip1"](this);
            ...
            if (item) {
                ...
                switch (featureClass.type) {
                    case _geometry_geometry__WEBPACK_IMPORTED_MODULE_1__["GeometryType"].Point:
                        ...
                        if (this.number == 0) {
                            const symbol1 = new _symbol_symbol__WEBPACK_IMPORTED_MODULE_0__["LetterSymbol"](); //点的渲染
                    ...
                    case _geometry_geometry__WEBPACK_IMPORTED_MODULE_1__["GeometryType"].Polygon:
                        ...
                        symbol3.fillStyle = _util_color__WEBPACK_IMPORTED_MODULE_2__["Color"].random2().toString();
                        symbol3.strokeStyle = _util_color__WEBPACK_IMPORTED_MODULE_2__["Color"].random2().toString();
                        item.symbol = symbol3;
                        item.value = value;
                        this._items.push(item);
                        break;
...
/*!****************************************!*\
  !*** ../dist/renderer/dot-renderer.js ***!
  \****************************************/
/*! exports provided: DotRenderer1, DotRenderer2, DotRenderer3, DotRenderer4, DotRenderer5 */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DotRenderer1", function() { return DotRenderer1; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DotRenderer2", function() { return DotRenderer2; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DotRenderer3", function() { return DotRenderer3; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DotRenderer4", function() { return DotRenderer4; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DotRenderer5", function() { return DotRenderer5; });
/* harmony import */ var _symbol_symbol__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../symbol/symbol */ "../dist/symbol/symbol.js");
...
class DotRenderer1 {
    ...
    getSymbol(feature) {
        const symbol = new _symbol_symbol__WEBPACK_IMPORTED_MODULE_0__["LetterSymbol"]();
        symbol.radius = 12;
        symbol.letter = "果";
        symbol.fontColor = "#ffffff";
        symbol.fontSize = 14;
...
/* harmony import */ var _label_collision__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../label/collision */ "../dist/label/collision.js");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
class Symbol {
    constructor() {
         ...
         * 描边样式s
         */
        this.strokeStyle = "#ff9000";
        /**
         * 填充样式
         */
        // public fillStyle: string = "#ff000088";
        this.fillStyle = "#ff900066";
    }
}
/**
 * 点符号基类
...
class SimpleTextSymbol extends Symbol {
    constructor() {
        super(...arguments);
        this.collision = new _label_collision__WEBPACK_IMPORTED_MODULE_1__["SimpleCollision"]();
        /**
         * 边框宽
         */
        this.lineWidth = 3;
         ...
         * 放置位置
         */
        this.placement = "RIGHT"; //BOTTOM TOP LEFT RIGHT
        /**
         * 自动调整位置
         */
        this.auto = true;
...
class Tooltip1 {
    ...
    constructor(map) {
        ...
        this._tooltipContainer.appendChild(this._tooltipArrow);
        this._tooltipText = document.createElement("div");
        _util_utility__WEBPACK_IMPORTED_MODULE_0__["Utility"].addClass(this._tooltipText, "green-tooltip-text1");
        this._tooltipContainer.appendChild(this._tooltipText);
    }
    /**
     * 显示Tooltip
     ...
     * @param {number} height - 设置限高
     */
    show1(text, screenX, screenY, height) {
        if (typeof text === 'string') {
            this._tooltipText.innerHTML = text;
        }
        else {
...
class Color {
    ...
    static random2() {
        return new Color(Math.random() * 255, Math.random() * 255, Math.random() * 255, 0.3);
    }
}
...
input: "end",
  ...
      dog.onload = (event) => {
          const featureClass = new _dist__WEBPACK_IMPORTED_MODULE_0__["FeatureClass"](_dist__WEBPACK_IMPORTED_MODULE_0__["GeometryType"].MultiPolygon);
  ...
          renderer.symbol = new _dist__WEBPACK_IMPORTED_MODULE_0__["SimpleFillSymbol"]();
 ...
 container_check.checked=true;
  ...
  req.onload = (event) => {
          ...
          const featureLayer = new _dist__WEBPACK_IMPORTED_MODULE_0__["FeatureLayer"]();
          featureLayer.featureClass = featureClass;
          const label = new _dist__WEBPACK_IMPORTED_MODULE_0__["Label"]();        //生成一个lable
          const symbol = new _dist__WEBPACK_IMPORTED_MODULE_0__["SimpleTextSymbol"]();//生成一个symbol
          ...
          field.pro_fourthsector='pro_fourthsector';
          ...
          label.symbol = symbol;
          const renderer = new _dist__WEBPACK_IMPORTED_MODULE_0__["DotRenderer4"]();
    ...
    featureLayer.on("click", (event) => {
      ...
      pro_botton.onclick=function(){
        //alert(event.feature.properties.company_name);
        $('#table-body').empty()
        $('#container_pro2').empty();
        $('#pagination-wrapper').empty()
        var pro_name_botton=event.feature.properties.pro_name;
     
        check_company_botton(pro_name_botton);

      }
      pro_botton.onmouseover=function(){
        this.style.opacity="0.6";
               
       }
      pro_botton.onmouseout=function(){
   ...
   if (box1.checked==true){
     ...
     //  let old;
       ...
       //企业信息
       const featureClass1 = new _dist__WEBPACK_IMPORTED_MODULE_0__["FeatureClass"]();
       featureClass1.loadGeoJSON1(JSON.parse(req.responseText));
       const featureLayer1 = new _dist__WEBPACK_IMPORTED_MODULE_0__["FeatureLayer"]();
       featureLayer1.featureClass = featureClass1;
       const label1 = new _dist__WEBPACK_IMPORTED_MODULE_0__["Label"]();        //生成一个lable
       const symbol1 = new _dist__WEBPACK_IMPORTED_MODULE_0__["SimpleTextSymbol"]();//生成一个symbol
       symbol1.pointSymbolWidth=40;
       symbol1.pointSymbolHeight=40;
       symbol1.auto=true;
       symbol1.strokeStyle="#5ebfe2";
       symbol1.fontColor="#5ebfe2";
       const field1 = new _dist__WEBPACK_IMPORTED_MODULE_0__["Field"]();
       ...
       field1.radius='company_radius';
       field1.type = _dist__WEBPACK_IMPORTED_MODULE_0__["FieldType"].String;
       label1.field = field1; //label.field
       label1.symbol = symbol1;
       const renderer1 = new _dist__WEBPACK_IMPORTED_MODULE_0__["DotRenderer2"]();
       renderer1.field=field1;
     ...
     //    let old1;
       ...
       JSON.parse(req.responseText).features.map(item=> { 
         ...
         const polyline = new _dist__WEBPACK_IMPORTED_MODULE_0__["Polyline"]([item.point,item.point1]);
         const animation = new _dist__WEBPACK_IMPORTED_MODULE_0__["LineAnimation"](polyline);
         if(item.pro_year==2018){
       
          animation.startColor="rgb(16, 180, 44)";
          
         }
         if(item.pro_year==2019){
       
           animation.startColor="rgb(139, 34, 238)";
           
          }
          if(item.pro_year==2020){
       
           animation.startColor="#ff0000";
       ...
       //2019
       var map_ply=document.getElementById("fly");

       fly.onclick=function(){
         
         if(map_ply.checked==true && box1.checked==true){
           map.clearAnimations();
           map.setView([112.561841, 37.731984],12);
           JSON.parse(req.responseText).features.map(item=> { 
       ...
       //2018
       var map_ply1=document.getElementById("fly1");

       fly1.onclick=function(){
         
         if(map_ply1.checked==true && box1.checked==true){
           map.clearAnimations();
           map.setView([112.561841, 37.731984],12);
           JSON.parse(req.responseText).features.map(item=> { 
       ...
       //2020
       var map_ply2=document.getElementById("fly2");
       fly2.onclick=function(){
         
         if(map_ply2.checked==true && box1.checked==true){
           map.clearAnimations();
           map.setView([112.561841, 37.731984],12);
           JSON.parse(req.responseText).features.map(item=> { 
  ...
  //返回数据
    ...
    req.open("GET", "/static/js/projection.json", true);
   //req.open("GET",url,true);
    req.send(null);
  ...
  req.onreadystatechange=function(){  
   ...
   for(ii;ii<=maxid-1;ii++)
    ...
                       var n=JSON.parse(req.responseText).features[ii].pro_name;
                      
    ...
                          list[j].addEventListener("click", function(e) {
        ...
                              map.setView([k,o],20);
                              ...
                              box2.checked=false;
                              map.clearAnimations();
                              const n="http://119.29.130.157:8000/ProMultisearch/?pro_name="+document.getElementById(j).innerText;;
                              ...
                              label.field = field; //label.field
                              label.symbol = symbol;
                              const renderer = new DotRenderer4();
                              renderer.field=field;
                              featureLayer.rasterLayer;
                              featureLayer.renderer = renderer;
                              featureLayer.label = label; // 把label给featurelayer
...
                    // var o=JSON.parse(req.responseText).features[j].point[1];
                     ...
                     map.clearAnimations();
                     const n="http://119.29.130.157:8000/ProMultisearch/?pro_prisectorsector="+document.getElementById("id"+j).innerText;;
                     const req = new XMLHttpRequest();
                     const url=n;
                     req.onload = (event) => {
                     const featureClass = new _dist__WEBPACK_IMPORTED_MODULE_0__["FeatureClass"]();
...
                    // var o=JSON.parse(req.responseText).features[j].point[1];
                            ...
                            box.checked=false; 
                            box2.checked=false;
                            const n="http://119.29.130.157:8000/ProMultisearch/?pro_fourthsector="+document.getElementById("chanye_"+chanye_j).innerText;
...
road_sure_click.onclick=function(){
 ...
 document.getElementById("search_sure_click").onclick=function(){
  if(document.getElementById("select").value!="" )
   ...
   const req = new XMLHttpRequest();
   const url5='http://119.29.130.157:8000/ProMultisearch/?pro_'+document.getElementById("select").value;
  

   const url=url5+myinput_sure_value.value;
   req.onload = (event) => {
     const featureClass = new _dist__WEBPACK_IMPORTED_MODULE_0__["FeatureClass"]();
     featureClass.loadGeoJSON(JSON.parse(req.responseText));
     const featureLayer = new _dist__WEBPACK_IMPORTED_MODULE_0__["FeatureLayer"]();
...
function check_search2(url_address) {    
  var relativeSearch = (function() {
    ...
                                success: function(result) {
                                    ...
                                    var  container_data_number = document.getElementById('container_pro3') ;
                                  ...
                                  //   var list_data=JSON.parse(result)
                                      ...
                                      function buildTable() {
                                          ...
                                          for (var i  in myList) {
                                           console.log(myList)
                                           if(myList[i].pro_name!==undefined){
                                               var a=document.createElement("a")
                                               a.setAttribute("style","background-color:white;color:gray;width:100px;height:200px ;font-size: 20px;")
                                               a.id="pro_name_search"+i
                                               const pro_id=a.id
                                               var pro_row=myList[i].pro_name
                                               var c=document.createTextNode(pro_row);
                                               a.appendChild(c)
                                               var img = document.createElement("img")
                                               img.src="/static/images/定位4.svg"
                                               ...
                                               a.onclick=function(){
                                                ...
                                                box2.checked=false;
                                                box1.checked=false;
                                               // map.setView([112.561841, 37.731984],9);  
                                                map.clearAnimations();
                                                const n="http://119.29.130.157:8000/ProMultisearch/?pro_name="+document.getElementById(pro_id).innerText;
                                                const req1 = new XMLHttpRequest();
                                                const url=n;
                                                req1.onload = (event) => {
                                                const featureClass = new _dist__WEBPACK_IMPORTED_MODULE_0__["FeatureClass"]();
 ...
 // var cansole=document.getElementById("cansole");
  search.onclick=function(){
    ...
    navList[4].click();
    const req = new XMLHttpRequest();
    const url5='http://119.29.130.157:8000/ProMultisearch/?pro_'+document.getElementById("select_lower").value;
...
                            success: function(result) {
                                 ...
                                 var  container_data_number = document.getElementById('container_pro2') ;
                                 var  cc = document.createTextNode('总计' + result_length + '个标注');
                                 container_data_number.appendChild(cc);
                                              ...
                                              a.onclick=function(){
                                                   ...
                                                                       //  map.setView([k,o],20);
                                                                         ...
                                                                         req1.onload = (event) => {
                                                                           ...
                                                                           label.field = field; //label.field
                                                                           label.symbol = symbol;
                                                                           const renderer = new _dist__WEBPACK_IMPORTED_MODULE_0__["DotRenderer2"]();
                                                                           renderer.field=field;
                                                                           featureLayer.renderer = renderer;
                                                                           featureLayer.label = label; // 把label给featurelayer
                                                                           featureLayer.labeled = true;
           ...
                                               img.src="/static/images/定位1.svg"
                           ...
                                               //  map.setView([k,o],20);
                                                ...
                                                req1.onload = (event) => {
                                                  ...
                                                  label.field = field; //label.field
                                                  label.symbol = symbol;
                                                  const renderer = new _dist__WEBPACK_IMPORTED_MODULE_0__["DotRenderer1"]();
                                                  renderer.field=field;
                                                  featureLayer.renderer = renderer;
                                                  featureLayer.label = label; // 把label给featurelayer
                                                  featureLayer.labeled = true; ///////
         ...
                                             img.src="/static/images/定位2.svg"
                         ...
                                             //  map.setView([k,o],20);
                                               ...
                                               req1.onload = (event) => {
                                                 ...
                                                 label.field = field; //label.field
                                                 label.symbol = symbol;
                                                 const renderer = new _dist__WEBPACK_IMPORTED_MODULE_0__["DotRenderer5"]();
                                                 renderer.field=field;
...
                            type: "get",
                            async: false, //同步执行
                            url: "http://119.29.130.157:8000/programe/",
...
                            success: function(result) {
                         //   console.log(JSON.parse(result).features)
                            ...
                            var result_length = JSON.parse(result).count
                            var  container_data_number = document.getElementById('container_pro1') ;
                            var  cc = document.createTextNode('总计' + result_length + '个标注');
                            container_data_number.appendChild(cc);  
                            var state = {
                              'querySet': list_data,
                           ...
                           function pageButtons(pages) {
                               ...
                               $('.page').on('click', function() {
                                  ...
                                  riding.clear(); 
                                  map.clearAnimations();
                                  const n="http://119.29.130.157:8000/programe/?page="+this.value;
                                  const req1 = new XMLHttpRequest();
                                  const url=n;
                                  req1.onload = (event) => {
                                  const featureClass = new _dist__WEBPACK_IMPORTED_MODULE_0__["FeatureClass"]();
...
function check_company_botton(data_botton) {
  ...
  function autoInput(){
    ...
                       async: false, //同步执行
                                //url: "http://119.29.130.157:8000/boot/"+realtivedata,
                       url:'http://119.29.130.157:8000/ProMultisearch/?pro_name='+keywords,
                       dataType: "text", //返回数据形式为json
                       success: function(result) {
                     ...
                     const urlTrue1 ='http://119.29.130.157:8000/ProMultisearch/?pro_name='+keywords;
...
/******/ });
//# sourceMappingURL=bundle-04.js.map