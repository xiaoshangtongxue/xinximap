...
var ret7 = (function() {
    ...
    // for (var i = 0; i < (Data7.length) / 3; i++) {
    //     Hang_Ye = Data7[i].HangYe
    //     Shu_Liang = Data7[i].ShuLiang + Data7[i + (Data7.length) / 3].ShuLiang + Data7[i + 2 * (Data7.length) / 3].ShuLiang
    ...
    for (var j = 0; j < read_Hang_Ye.length; j++) {
        for (var i = 0; i < Data7.length; i++) {
            if (read_Hang_Ye[j] == Data7[i].HangYe) {
                //2018
                if (Data7[i].RenDingShiJian == '2018') {
                ...
                //2019
                if (Data7[i].RenDingShiJian == '2019') {
                ...
                //2020
                if (Data7[i].RenDingShiJian == '2020') {
