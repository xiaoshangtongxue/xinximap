...
import {Collision,CoverCollision, SimpleCollision} from "../label/collision";
...
export class Symbol {
     ...
     * 描边样式s
     */
    public strokeStyle: string = "#ff9000";
    /**
     * 填充样式
     */
  // public fillStyle: string = "#ff000088";
     public fillStyle: string = "#ff900066";
}
...
export class SimpleTextSymbol extends Symbol {
     ...
     * 放置位置
     */
    public placement: string = "RIGHT";   //BOTTOM TOP LEFT RIGHT
    /**
     * 自动调整位置
     */
